...
export default {
  ...
  getKid(){
  var self = this;
  axios.get('https://api.themoviedb.org/3/discover/movie?api_key=b835ed932f4f0a4532e2512ff3cce439&certification_country=US&certification.lte=G&sort_by=popularity.desc')
...
background-image: url("fondoKid.jpg");
